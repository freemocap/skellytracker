...
const config: Config = {
  title: 'skellytracker',
  tagline: 'Documentation for skellytracker',
  favicon: 'img/favicon.ico',

  url: 'https://freemocap.github.io',
  baseUrl: '/skellytracker/',

  organizationName: 'freemocap',
  projectName: 'skellytracker',
    ...
    [
      'classic',
      {
        docs: {
          ...
          // Docs-only mode: serve docs at the site root so `/` opens the intro
          // page directly (there is no separate marketing landing page).
          routeBasePath: '/',
          editUrl: 'https://github.com/freemocap/skellytracker/tree/main/skellytracker-docs/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        { href: 'https://github.com/freemocap/skellytracker', label: 'Code', position: 'right' },
      ],
    },
    footer: {
      style: 'dark',
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Source Code', href: 'https://github.com/freemocap/skellytracker' },
        ...
        },
        {
          ...
          items: [
            { label: 'Blog', to: '/blog' },
            { label: 'Website', href: 'https://docs.freemocap.org/skellytracker' },
          ],
        },
      ],
