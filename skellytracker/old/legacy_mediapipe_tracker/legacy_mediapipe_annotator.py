...
from skellytracker.old.base_tracker.base_tracker_abcs import BaseImageAnnotatorConfig, BaseImageAnnotator
...
class LegacyMediapipeImageAnnotator(BaseImageAnnotator):
    ...
    def annotate_image(
        ...
        if self.config.show_overlay and observation.segmentation_mask is not None:
            annotated_image[:, :, 2] += (observation.segmentation_mask * 50).astype('uint8')

        drawing_utils.draw_landmarks(
            image=annotated_image,
            landmark_list=observation.pose_landmarks,
        ...
        drawing_utils.draw_landmarks(
            image=annotated_image,
            landmark_list=observation.right_hand_landmarks,
        ...
        drawing_utils.draw_landmarks(
            image=annotated_image,
            landmark_list=observation.left_hand_landmarks,
            connections=mp_holistic.HAND_CONNECTIONS,
        ...
        drawing_utils.draw_landmarks(
            image=annotated_image,
            landmark_list=observation.face_landmarks,
