...
from skellytracker.old.legacy_mediapipe_tracker.legacy_mediapipe_annotator import LegacyMediapipeAnnotatorConfig, \
...
from skellytracker.old.legacy_mediapipe_tracker.legacy_mediapipe_detector_config import \
