...
from skellytracker.old.mediapipe_tracker.hands.mediapipe_hand_observation import MediapipeHandObservation
from skellytracker.old.mediapipe_tracker.names_and_connections import MEDIAPIPE_HAND_DEFINITION
