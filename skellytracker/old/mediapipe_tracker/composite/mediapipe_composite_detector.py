...
from skellytracker.old.mediapipe_tracker.composite.composite_tracker_mappings import (
    HAND_WRIST_INDEX,
    POSE_LEFT_EAR_INDEX,
...
from skellytracker.old.mediapipe_tracker.composite.mediapipe_composite_observation import (
    MediapipeCompositeObservation,
    ROIBox,
)
from skellytracker.old.mediapipe_tracker.face.mediapipe_face_detector import MediapipeFaceDetector
from skellytracker.old.mediapipe_tracker.face.mediapipe_face_observation import MediapipeFaceObservation
from skellytracker.old.mediapipe_tracker.hands.mediapipe_hand_detector import MediapipeHandDetector
from skellytracker.old.mediapipe_tracker.hands.mediapipe_hand_observation import (
    NUM_HAND_LANDMARKS,
