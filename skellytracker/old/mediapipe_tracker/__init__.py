...
if TYPE_CHECKING:  # static-tooling visibility; resolved lazily at runtime above
    from skellytracker.old.mediapipe_tracker.__mediapipe_tracker import MediapipeCompositeTracker as MediapipeTracker
    from skellytracker.old.mediapipe_tracker.body.mediapipe_pose_tracker import MediapipePoseTracker
    ...
    from skellytracker.old.mediapipe_tracker.composite.mediapipe_composite_config import MediapipeCompositeDetectorConfig as MediapipeDetectorConfig
    from skellytracker.old.mediapipe_tracker.composite.mediapipe_composite_detector import MediapipeCompositeDetector as MediapipeDetector
    from skellytracker.old.mediapipe_tracker.composite.mediapipe_composite_observation import MediapipeCompositeObservation as MediapipeObservation
    from skellytracker.old.mediapipe_tracker.composite.mediapipe_composite_tracker_config import MediapipeCompositeTrackerConfig as MediapipeTrackerConfig
    from skellytracker.old.mediapipe_tracker.face.mediapipe_face_tracker import MediapipeFaceTracker
    from skellytracker.old.mediapipe_tracker.hands.mediapipe_hand_tracker import MediapipeHandTracker
