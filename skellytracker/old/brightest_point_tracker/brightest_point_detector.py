...
from skellytracker.old.base_tracker.base_tracker_abcs import BaseDetector, BaseDetectorConfig, TrackerType
from skellytracker.old.brightest_point_tracker.brightest_point_observation import BrightPatch, \
