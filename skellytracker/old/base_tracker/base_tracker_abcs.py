...
class BaseTracker(ABC):
    ...
    def demo(self) -> None:
        from skellytracker.old.io.demo_viewers.webcam_demo_viewer import WebcamDemoViewer
    ...
    def image_demo(self, image_path: Path) -> None:
        from skellytracker.old.io.demo_viewers.image_demo_viewer import ImageDemoViewer
