...
from skellytracker.old.system.default_paths import FIGSHARE_CHARUCO_TEST_IMAGE_URL
from skellytracker.old.utilities.download_test_image import download_test_image
