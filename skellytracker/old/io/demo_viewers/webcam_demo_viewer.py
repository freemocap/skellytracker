        ...
        while True:
            ...
            if key == KEY_QUIT_Q or key == KEY_QUIT_ESC:
                ...
                if "brightestpoint" not in self.tracker.__class__.__name__.lower():
                    ...
                    from skellytracker.old.brightest_point_tracker import BrightestPointTracker
                ...
                if "charuco" not in self.tracker.__class__.__name__.lower():
                    ...
                    from skellytracker.old.charuco_tracker import CharucoTracker
                ...
                if "mediapipe" not in self.tracker.__class__.__name__.lower():
                    ...
                    from skellytracker.old.mediapipe_tracker import MediapipeTracker
