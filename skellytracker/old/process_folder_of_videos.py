...
from skellytracker.old.system.constants import BASE_2D_FILE_NAME
from skellytracker.old.base_tracker.base_tracker_abcs import BaseTracker
from skellytracker.old.brightest_point_tracker.brightest_point_tracker import (
    BrightestPointTracker,
)
from skellytracker.old.utilities.get_video_paths import get_video_paths

try:
    from skellytracker.old.v1.yolo_mediapipe_combo_tracker.yolo_mediapipe_combo_tracker import (
...
try:
    from skellytracker.old.v1.yolo_tracker import YOLOPoseTracker
    from skellytracker.old.v1.yolo_tracker import YOLOTrackingParams
except ModuleNotFoundError:
...
try:
    from skellytracker.old.v1.openpose_tracker.openpose_tracker import (
        OpenPoseTracker,
    )
except ModuleNotFoundError:
