...
def parse_args():
    ...
    parser.add_argument(
        'inputs',
        type=str,
        default = r"C:\Users\jonma\freemocap_data\recording_sessions\_SfN2023_demo_recordings\session_2023-04-26_13_45_33_jpcf\recording_13_54_13_gmt-4__jpcf_ring\synchronized_videos\Camera_001_synchronized.mp4",
        nargs='?',
