...
Usage::
    ...
    uv run python -m skellytracker.core.detectors.keypoint_detectors.rtmpose.face.run_demo
    uv run python -m skellytracker.core.detectors.keypoint_detectors.rtmpose.face.run_demo --camera 1
    uv run python -m skellytracker.core.detectors.keypoint_detectors.rtmpose.face.run_demo --provider cpu
"""
