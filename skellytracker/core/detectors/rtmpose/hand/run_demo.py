...
Usage::
    ...
    uv run python -m skellytracker.core.detectors.rtmpose.hand.run_demo
    uv run python -m skellytracker.core.detectors.rtmpose.hand.run_demo --camera 1
    uv run python -m skellytracker.core.detectors.rtmpose.hand.run_demo --provider cpu
"""
