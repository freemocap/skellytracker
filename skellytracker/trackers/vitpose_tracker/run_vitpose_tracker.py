...
from skellytracker.trackers.old.vitpose_tracker.vitpose_annotator import VITPoseAnnotator
from skellytracker.trackers.old.vitpose_tracker.vitpose_detector import (
    VITPoseDetector,
