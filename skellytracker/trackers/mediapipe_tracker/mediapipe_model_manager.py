...
def _filename_from_url(url: str) -> str:
    """Derive a unique filename from a URL."""
...
def get_model_path(url: str) -> Path:
    """Get local path for a model, downloading if not already cached."""
...
def get_hand_model_path() -> Path:
    """Get local path for the hand landmarker model."""
    return get_model_path(url=HAND_MODEL_URL)


def get_face_model_path() -> Path:
    """Get local path for the face landmarker model."""
