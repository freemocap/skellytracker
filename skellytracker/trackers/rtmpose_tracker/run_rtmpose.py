...
from skellytracker.trackers.old.rtmpose_tracker.rtmpose_annotator import RTMPoseImageAnnotator
from skellytracker.trackers.old.rtmpose_tracker.rtmpose_detector import (
    RTMPoseDetector,
